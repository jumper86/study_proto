...
type SimpleClient interface {
	GetPerson(ctx context.Context, in *Ids, opts ...grpc.CallOption) (*Person, error)
}
...
func (c *simpleClient) GetPerson(ctx context.Context, in *Ids, opts ...grpc.CallOption) (*Person, error) {
	out := new(Person)
	err := c.cc.Invoke(ctx, "/code.Simple/GetPerson", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServer interface {
	GetPerson(context.Context, *Ids) (*Person, error)
...
func (UnimplementedSimpleServer) GetPerson(context.Context, *Ids) (*Person, error) {
...
func _Simple_GetPerson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Ids)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServer).GetPerson(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/code.Simple/GetPerson",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServer).GetPerson(ctx, req.(*Ids))
	}
...
var Simple_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "code.Simple",
	HandlerType: (*SimpleServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetPerson",
			Handler:    _Simple_GetPerson_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "code/simple.proto",
}
